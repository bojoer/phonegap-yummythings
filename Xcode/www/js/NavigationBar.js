//
//  NavigationBar.js
//  This JavaScript file defines Cordova plugin as module
// 
//  PhoneGap iOS Native Navigation Bar plugin.
//  Code influenced by:
//  NativeControls plugin
//  Hiedi Utley https://github.com/hutley/HelloPhoneGap1.0/
//  AndiDog: https://github.com/AndiDog/phonegap-ios-navigationbar-plugin
//  zSprawl https://github.com/zSprawl/NativeControls/
//
...
cordova.define("cordova/plugin/iOSNavigationBar", function(require, exports, module) {
               ...
               /**
                * init must be called (plugin initializedbefore any other method
                * in order to initialize the plugin.
                */
               ...
               NavigationBar.prototype.create = function(style, options) {
                options = options || {};
                if(!("style" in options)) options.style = style || "Default";
